    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: Colors.surface }}>
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32 }}>
          ...
          <Text style={{ fontSize: 18, fontWeight: 'bold', color: Colors.dark, marginTop: 16, textAlign: 'center' }}>
          ...
          <Text style={{ fontSize: 14, color: Colors.muted, marginTop: 8, textAlign: 'center' }}>
            {t('saved.login_sub', 'Save properties you love and access them anytime')}
          </Text>
          <TouchableOpacity
            onPress={() => router.push('/(auth)/phone')}
            style={{ marginTop: 24, backgroundColor: Colors.yellow, paddingHorizontal: 32, paddingVertical: 14, borderRadius: 30 }}
          >
      ...
      <View style={{ paddingHorizontal: 16, paddingVertical: 16 }}>
        ...
        {savedProperties.length > 0 && (
          <Text style={{ fontSize: 13, color: Colors.muted, marginTop: 4 }}>
            {t('saved.count', '{{count}} saved', { count: savedProperties.length })}
          </Text>
        )}
      </View>
