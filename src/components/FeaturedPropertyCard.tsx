...
export const FeaturedPropertyCard: React.FC<FeaturedPropertyCardProps> = ({
  ...
  const coverImage =
    property.propertyMedia?.find((m) => m.isCover)?.url ??
    property.propertyMedia?.[0]?.url;
  ...
  return (
    ...
    >
      ...
      <View style={{ padding: 14 }}>
        ...
        <Text
          style={{ fontSize: 16, fontWeight: 'bold', color: Colors.dark, marginBottom: 4 }}
          numberOfLines={1}
        >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
          <Ionicons name="location-outline" size={13} color={Colors.muted} style={{ marginRight: 4 }} />
        ...
        <View style={{ flexDirection: 'row', gap: 6 }}>
          ...
          >
            <Text style={{ color: '#25D366', fontWeight: 'bold', fontSize: 12 }}>
              WhatsApp
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text style={{ color: Colors.dark, fontWeight: 'bold', fontSize: 12 }}>
