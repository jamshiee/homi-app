...
export function PropertyQuickFactsSection({
  property,
}: PropertyQuickFactsSectionProps) {
  ...
  const getFacts = () => {
    ...
    if (property.type === PropertyTypeEnum.LAND && property.landDetail) {
      ...
      property.type === PropertyTypeEnum.HOUSE &&
      property.houseDetail
    ) {
      if (property.houseDetail.bedrooms) {
        facts.push({
          icon: "bed-outline",
          value: `${property.houseDetail.bedrooms} ${t("property.beds")}`,
        });
      }
      if (property.houseDetail.bathrooms) {
        facts.push({
          icon: "water-outline",
          value: `${property.houseDetail.bathrooms} ${t("property.baths")}`,
        });
      }
      if (property.houseDetail.floors) {
        facts.push({
          icon: "layers-outline",
          value: `${property.houseDetail.floors} ${t("property.floors")}`,
        });
      }
      if (property.houseDetail.balconies !== undefined) {
        facts.push({
          icon: "grid-outline",
          value: `${property.houseDetail.balconies} ${t("property.balconies")}`,
        });
      }
      if (property.houseDetail.furnishingStatus) {
        facts.push({
          ...
          value:
            ...
            FurnishingStatusEnum.FULLY_FURNISHED
              ? t("property.furnished")
              : property.houseDetail.furnishingStatus ===
                  FurnishingStatusEnum.SEMI_FURNISHED
      ...
      property.type === PropertyTypeEnum.BUILDING &&
      property.buildingDetail
    ) {
      if (property.buildingDetail.totalArea) {
        facts.push({
          icon: "expand-outline",
          value: `${property.buildingDetail.totalArea} ${property.buildingDetail.areaUnit ?? "Unit"}`,
        });
      }
      if (property.buildingDetail.floorNumber !== undefined) {
        facts.push({
          icon: "layers-outline",
          value: `${t("property.floor")}: ${property.buildingDetail.floorNumber}`,
        });
      }
      ...
      property.type === PropertyTypeEnum.HOTEL &&
      property.hotelDetail
    ) {
      console.log("hotelDetail: ", property.hotelDetail);
      if (property.hotelDetail.hotelCategory) {
        const categoryIconMap: Record<
          HotelCategoryEnum,
          keyof typeof Ionicons.glyphMap
        > = {
          [HotelCategoryEnum.LUXURY]: "diamond-outline",
          [HotelCategoryEnum.PREMIUM]: "ribbon-outline",
          [HotelCategoryEnum.CLASSIC]: "star-outline",
        };

        facts.push({
          icon: categoryIconMap[property.hotelDetail.hotelCategory],
          value: property.hotelDetail.hotelCategory.replaceAll("_", " ") 
          // + " " + property.hotelDetail.subType.charAt(0).toUpperCase() + property.hotelDetail.subType.slice(1),
        });
      }
      ...
      if (property.hotelDetail.occupancy) {
        facts.push({
          icon: "people-outline",
          value: property.hotelDetail.occupancy,
        });
      }
      if (property.hotelDetail.mealsIncluded) {
        facts.push({
          icon: "restaurant-outline",
          value: t("property.meals_included"),
        });
      }
    }
    ...
    <View className="px-4 py-5">
      ...
      <View className="flex-row flex-wrap justify-between gap-y-3">
        {facts.map((fact) => (
          ...
          >
            <Ionicons name={fact.icon as any} size={18} color={Colors.dark} />
